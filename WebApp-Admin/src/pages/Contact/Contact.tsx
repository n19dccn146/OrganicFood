    ...
    <div className="flex flex-wrap">
      <div className="grow-0 shrink-0 basis-auto mb-12 lg:mb-0 w-full lg:w-5/12 px-3 lg:px-6">
        ...
        <div className="form-group form-check text-center mb-6">
          ...
          transition
          duration-150
          ease-in-out" onClick={(e)=>{e.preventDefault()}}>Send</button>
        </form>
      </div>
          ...
          <div className="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
            <div className="flex items-start">
              ...
              <div className="grow ml-6">
                ...
                <p className="text-gray-500">hieubui@gmail.com</p>
                <p className="text-gray-500">0919 919 752</p>
              </div>
            </div>
          </div>
          <div className="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
            <div className="flex items-start">
              ...
              <div className="grow ml-6">
                ...
                <p className="text-gray-500">binhphuoi@gmail.com</p>
                <p className="text-gray-500">0167 7797 534</p>
              </div>
            </div>
          </div>
          <div className="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
            <div className="flex align-start">
              ...
              <div className="grow ml-6">
                ...
                <p className="text-gray-500">johnwick@hcmute.edu.com</p>
                <p className="text-gray-500">0978 754 132</p>
              </div>
            </div>
          </div>
          <div className="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
            <div className="flex align-start">
              ...
              <div className="grow ml-6">
                ...
                <p className="text-gray-500">headincloud@usa.com</p>
                <p className="text-gray-500">0131 133 331</p>
              </div>
            </div>
          </div>
        </div>
